...
pub fn render(app: &App, frame: &mut Frame) {
    ...
    match app.screen {
        ...
        Screen::P2pIdentity   => overlays::render_p2p_identity_screen(app, frame, body_area),
        ...
        Screen::Settings      => settings::render_settings(app, frame, body_area),
    }
...
fn render_footer(app: &App, frame: &mut Frame, area: Rect) {
    ...
    let help = if app.gematria_state.is_some() {
        ...
        match app.screen {
            ...
            Screen::Settings      => " [↑↓] Navigate  [Enter/F2] Edit  [S] Save & reload  [Esc] Back",
        }
    };
